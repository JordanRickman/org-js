 ...
 * @property {boolean} toc - Whether to include a table of contents.
 * @property {boolean} num - Whether to include dotted section numbers in header elements.
 * @property {string} "^" - Apparently something to do with how the converter handles subscripts. To be deprecated. 
 * @todo Potentially deprecate toc and num - only used by converter, not parser.
 * @property {boolean} multilineCell - Whether multi-line table cells are allowed.
 * 
 ...
 * @property {ParserOptions} options - Parsing options.
 */
 ...
 * @param {TextNode} term - The term being defined by this defintion.
 * @param {ModelNode[]} children - A list of sub-nodes.
 */
...
if (exports) {
  ...
  exports.DefinitionListElementNode = DefinitionListElementNode;
